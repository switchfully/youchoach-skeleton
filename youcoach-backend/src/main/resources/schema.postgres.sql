...
-- set schema 'youcoach';
drop table youcoach.coaching_session;
create table youcoach.coaching_session (
    coaching_session_id          bigint          NOT NULL  GENERATED BY DEFAULT as identity PRIMARY KEY,
    subject     text            NOT NULL,
    date        timestamp       NOT NULL,
    location    text            NOT NULL,
    remarks     text,
    coach_id    bigint references youcoach.coaches(user_id),
    coachee_id  bigint references youcoach.members(id)
);
